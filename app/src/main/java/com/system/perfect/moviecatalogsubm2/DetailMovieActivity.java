...
public class DetailMovieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load("http://image.tmdb.org/t/p/w185/" + data.getPoster_path()).into(poster_path);
        Glide.with(this).load("http://image.tmdb.org/t/p/w500/" + data.getBackdrop_path()).into(backdrop_path);
